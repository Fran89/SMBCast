...
// Funtion Parses Shakemap & Sends
void SMBCast::parse_shakemapSend(QString fileName){
    Stas.clear(); // Clear any previous Model
...
// Draws the Table and Sends Email
void SMBCast::DrawTableSend(){
    ...
    qDebug() << "Finished Creating Table";
    SendEmail();
}
...
// Sends mail
void SMBCast::SendEmail(){

    qDebug() << "Starting Send Email";
